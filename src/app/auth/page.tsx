  ...
  return (
    <div className="gateway-container" style={{ background: '#f8fafc' }}>
      ...
      <div className="gateway-card" style={{ maxWidth: '400px', padding: '40px 32px' }}>
        ...
        {/* Brand Logo Header */}
        <div className="gateway-header" style={{ marginBottom: '20px' }}>
          ...
          <h1 className="gateway-title" style={{ fontSize: '22px', fontWeight: 800, marginTop: '12px' }}>Business Portal</h1>
          <p className="gateway-subtitle" style={{ fontSize: '13px', color: '#64748b' }}>Log in or register your business workspace</p>
        </div>
        ...
        <div style={{
          ...
          <button
            type="button"
            onClick={() => { setActiveTab('login'); setName(''); setEmailError(null); setPasswordError(null); }}
            style={{
              flex: 1,
              padding: '8px',
              border: 'none',
          ...
          <button
            type="button"
            onClick={() => { setActiveTab('signup'); setEmailError(null); setPasswordError(null); }}
            style={{
              flex: 1,
              padding: '8px',
              border: 'none',
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <button 
            ...
            style={{ padding: '12px', borderRadius: '8px', marginTop: '4px' }}
